...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # Default paths - fallback to SSD_MOUNT_POINT / HDD_MOUNT_POINT if set
        hot_path = os.getenv('SSD_MOUNT_POINT') or os.getenv('NAS_SSD_MOUNT') or '/mnt/ssd'
        cold_path = os.getenv('HDD_MOUNT_POINT') or os.getenv('NAS_HDD_MOUNT') or '/mnt/hdd'
